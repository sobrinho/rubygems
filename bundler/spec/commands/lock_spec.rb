...
RSpec.describe "bundle lock" do
  ...
  it "properly shows resolution errors including OR requirements" do
    ...
    expect(err).to eq <<~ERR.strip
      ...
      So, because railties = 7.0.3.1 OR = 7.0.4 could not be found in rubygems repository https://gem.repo4/, cached gems or installed locally,
  ...
  it "is able to display some explanation on crazy irresolvable cases" do
    ...
    expect(err).to eq <<~ERR.strip
      ...
      So, because activemodel = 7.0.4 could not be found in rubygems repository https://gem.repo4/, cached gems or installed locally
