    ...
    context "allows only an older version" do
      ...
      context "with a Gemfile and lock file that don't resolve under the current platform" do
        ...
        it "raises a proper error" do
          ...
          nice_error = <<~E.strip
            Could not find gems matching 'sorbet-static (= 0.5.10554)' valid for all resolution platforms (arm64-darwin-21, aarch64-linux) in rubygems repository https://gem.repo4/, cached gems or installed locally.
      ...
      context "when adding a new gem that does not resolve under all locked platforms" do
        ...
        it "raises a proper error" do
          nice_error = <<~E.strip
            Could not find gems matching 'sorbet-static' valid for all resolution platforms (arm-linux, x86_64-linux) in rubygems repository https://gem.repo4/, cached gems or installed locally.
