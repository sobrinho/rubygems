...
RSpec.describe "bundle install from an existing gemspec" do
  ...
  it "should match a lockfile even if the gemspec defines development dependencies" do
    ...
    bundle "install", dir: tmp.join("foo"), artifice: "compact_index", env: { "BUNDLER_SPEC_GEM_REPO" => gem_repo1.to_s }
    ...
    output = bundle("install", dir: tmp.join("foo"), artifice: "compact_index", env: { "BUNDLER_SPEC_GEM_REPO" => gem_repo1.to_s })
